    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-lg"><b>FYA</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Deseas salir de el sistema FYA
                      <small>Si desea cerrar sesión precione el boton de abajo</small>
                    </p>
                  </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header"></li>
            @if(Auth::user()->permisos == 'admin' || Auth::user()->permisos == 'cv' || Auth::user()->permisos == 'c' )
            <li class="treeview">
              <a href="#">
            ...
            @endif
            @if(Auth::user()->permisos == 'admin' || Auth::user()->permisos == 'cv' || Auth::user()->permisos == 'v' )
            <li class="treeview">
              <a href="#">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="{{url('home')}}">FYA</a>.</strong> Todos los derechos reservados.
      </footer>
